...
public class ValidationUtils {
	public static Book validateBook(String isbn,String category,double price,String publishDate,String author,int quantity,List<Book> books) throws BookStoreException {
	...
	public static String validateIsbn(String isbn,List<Book> books) throws BookStoreException {
